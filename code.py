...
class Users:
    ...
    def save_to_csv(self, role):
        with open('users.csv', mode='a', newline='') as file:
            writer = csv.writer(file)
            writer.writerow([self.name, self.password, role])
...
class UserManager:
    ...
    def register(self, username, password, role="customer"):
        ...
        new_user = Customer(username, password) if role == "customer" else Manager(username, password)
        new_user.save_to_csv(role)
        return True
